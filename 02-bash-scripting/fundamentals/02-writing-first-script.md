...
Before a **Bash script** can be run directly, it must have execute permissions, which can be added using `chmod +x script.sh`. Once executable, the script can be run with `./script.sh`.
