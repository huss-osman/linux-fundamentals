...
This folder contains my core **Bash fundamentals** notes focused on practical Bash scripting workflows.
...
- Learn why Bash behaves the way it does, not just how to write scripts
