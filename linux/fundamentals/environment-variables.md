...
## Reflection
Learning about **environment variables** helped explain how applications receive configuration values dynamically without modifying source code. This concept is essential when working with **containers**, **cloud services**, and **CI/CD pipelines**, where configuration must adapt across different environments.
